      ...
      <div className="mx-auto max-w-6xl px-6 py-20">
        <div className="grid gap-12 md:grid-cols-3">
          <div>
            ...
            <p className="mt-4 max-w-xs font-body-serif text-sm leading-relaxed text-paper/70">
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <span className="font-utility text-[10px] uppercase tracking-wide text-paper/60">
                ISSN 2053-3209
              </span>
            </div>
          </div>
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-paper/10 pt-8 sm:flex-row">
          <p className="font-admin text-[11px] uppercase tracking-wide text-paper/60">
